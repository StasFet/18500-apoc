...
public class GoodnaSpecAuto extends CommandOpMode {
    ...
    private final Pose scoochPose = new Pose(39, 68, Math.toRadians(0));
    private final Pose scoreControlPose = new Pose(8.750, 70.000, Math.toRadians(0));
    private final Pose pickup1Pose = new Pose(61.500, 23.000, Math.toRadians(0));
    private final Pose pickup1Control1Pose = new Pose(9.900, 30.400, Math.toRadians(0));
    private final Pose pickup1Control2Pose = new Pose(68.000, 40.000, Math.toRadians(0));
    private final Pose dropoff1Pose = new Pose(20.000, 23.000, Math.toRadians(0));
    private final Pose pickup2Pose = new Pose(60.400, 12.900, Math.toRadians(0));
    ...
    private final Pose dropoff2Pose = new Pose(20.000, 13.000, Math.toRadians(0));
    private final Pose pickup3Pose = new Pose(60.000, 7.000, Math.toRadians(0));
    private final Pose pickup3ControlPose = new Pose(64.177, 15.116, Math.toRadians(0));
    private final Pose dropoff3Pose = new Pose(15,7,Math.toRadians(0));
    private final Pose parkPose = new Pose(8.750, 34.000, Math.toRadians(0));
    ...
    private void buildPaths() {
        ...
        parkApproach = follower.pathBuilder()
                .addPath(new BezierLine(new Point(scoochPose), new Point(parkApproachPose)))
                .setConstantHeadingInterpolation(Math.toRadians(0))
                .build();
